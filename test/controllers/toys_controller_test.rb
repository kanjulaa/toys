...
class ToysControllerTest < ActionController::TestCase
  ...
  test "should create toy" do
    assert_difference('Toy.count') do
      post :create, toy: { description: @toy.description, manufacturer: @toy.manufacturer, name: @toy.name, price: @toy.price, string: @toy.string }
    end
  ...
  test "should update toy" do
    patch :update, id: @toy, toy: { description: @toy.description, manufacturer: @toy.manufacturer, name: @toy.name, price: @toy.price, string: @toy.string }
    assert_redirected_to toy_path(assigns(:toy))
  end
